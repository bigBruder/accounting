      ...
      <div className="chart-tooltip">
        ...
        {payload.map((item: any, i: number) => (
          <div key={i} className="chart-tooltip__row">
            ...
            <span>{item.name === 'expense' ? t('common.expenses') : t('common.income')}:</span>
  ...
  return (
    <div className="chart-card">
      <div className="chart-card__header">
        <h3 className="section-title" style={{ marginBottom: 0 }}>{t('dashboard.dynamics')}</h3>
      ...
      {!hasData ? (
        <div className="chart-empty">
          ...
          <span className="chart-empty__text">{t('dashboard.insufficientData')}</span>
        </div>
      ) : view === 'daily' ? (
