  ...
  if (items.length === 0) {
    return (
      <div className="chart-card">
        <h3 className="section-title">{t('dashboard.expenseStructure')}</h3>
        <div className="chart-empty">
          <span className="chart-empty__icon">🍩</span>
          <span className="chart-empty__text">{t('dashboard.addExpensesForChart')}</span>
        </div>
      </div>
    );
  }
      ...
      <div className="donut-chart-container">
        <div className="donut-chart">
          ...
          <div className="donut-chart__center">
            ...
            <div className="donut-chart__label">{t('dashboard.total')}</div>
          </div>
        </div>
